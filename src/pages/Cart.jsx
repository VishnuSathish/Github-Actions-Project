...
const Cart = () => {
  ...
  const {products, cartItems, removeFromCart, getCartCount, navigate, getCartAmount, updateCart} = useAppContext()
    ...
    const [cartArray, setCartArray] = useState([])
     ...
     const getCart = ()=>{
      ...
      for (const item in cartItems) {
        const product = products.find((i)=>i.id === item )
        ...
        <div className="flex flex-col md:flex-row  py-16 max-w-6xl w-full px-6 mx-auto  ">
            <div className='flex-1 max-w-4xl'>
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        <p>Qty:</p>
                                        <select  onChange={e =>updateCart(product.id,Number(e.target.value))} value={cartItems[product.id]}   className='outline-none'>
                ...
                <button onClick={() => {navigate("/products"), scrollTo(0,0)}} className="group cursor-pointer flex items-center mt-8 gap-2 text-primary font-medium">
                    <svg width="15" height="11" viewBox="0 0 15 11" className="text-primary" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{selectedAddress ? `${selectedAddress.addressLine1},${selectedAddress.city}, ${selectedAddress.state}`: 'No address found' }</p>
