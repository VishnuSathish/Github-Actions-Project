...
const SellerLayout = () => {
  ...
  const {isSeller, setIsSeller, navigate}= useAppContext()
    ...
    return (
        <>
            <div className=" mx-4 flex items-center justify-between px-4 md:px-8 border-b border-gray-300 py-3 bg-white transition-all duration-300">
                <Link to='/'>
                    <img className="cursor-pointer w-10 h-10 md:w-38" src={assets.logo} />
                </Link>
